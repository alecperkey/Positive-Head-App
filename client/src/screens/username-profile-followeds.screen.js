...
class UsernameProfileFolloweds extends Component {
  ...
  constructor(props) {
    ...
    this.state = {
      ...
      resultsLength: (
        props.navigation.state.params
        && props.navigation.state.params.username
        && props.navigation.state.params.username.followeds
      ) ?
        props.navigation.state.params.username.followeds.length : 0,
  ...
  componentWillReceiveProps(nextProps) {
    ...
    const currentUsers = (
      ...
      && this.props.navigation.state.params.username.followeds
    ) ? this.props.navigation.state.params.username.followeds : [];
    const nextUsers = (
      nextProps.navigation.state.params
      && nextProps.navigation.state.params.username
      && nextProps.navigation.state.params.username.followeds
    ) ? nextProps.navigation.state.params.username.followeds : [];
...
UsernameProfileFolloweds.propTypes = {
...
export default UsernameProfileFolloweds;
